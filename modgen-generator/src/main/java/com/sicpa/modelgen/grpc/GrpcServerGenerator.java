 ...
 *
 */
public class GrpcServerGenerator extends AbstractGenerator {

	private String serviceTemplate = "grpc/grpcserver.ftl";
  ...
  private String rolePackage;
	...
	public GrpcServerGenerator(String outputDir, String packageName, String entityPackage,String entitySuffix, String entityRepositorySuffix, String dtoPackage, String repositoryPackage, String transformersPackage, String dtoSuffix, String protoBuffPackage, String servicePackage, String rolePackage) {
		super(outputDir);
	...
	protected void generateFiles(Map<String, Object> input) {
		...
		getMetaModels().values().forEach( m -> {
			...
			if(m.getType() == ClassifierType.CLASS){
				...
				String fileName = m.getName() + "GrpcServiceImpl.java";
